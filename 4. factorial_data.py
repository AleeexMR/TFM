...
# if we want to use the GCC matrix, call DM1 the line 109 and comment:
def slcd(D):
...
#########################################################################################
# Same fuzzy clustering algorithm than in script 2 but adapted to factorial data
#########################################################################################
...
real_clusters = [1] * 100 + [2] * 100 + [0] * 100
